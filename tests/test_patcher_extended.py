...
class TestVerboseLogging:
    ...
    @pytest.mark.asyncio
    async def test_verbose_logging_async(
        self, mock_rlm, mock_repl, mock_history, mock_variables
    ):
...
class TestAsyncSyntaxError:
    ...
    @pytest.mark.asyncio
    async def test_async_syntax_error_handling(
        self, mock_rlm, mock_repl, mock_history, mock_variables
    ):
...
class TestAsyncPreExecutionHook:
    ...
    @pytest.mark.asyncio
    async def test_async_pre_execution_hook_awaited(
        self, mock_rlm, mock_repl, mock_history, mock_variables
    ):
    ...
    @pytest.mark.asyncio
    async def test_sync_pre_execution_hook_in_async(
        self, mock_rlm, mock_repl, mock_history, mock_variables
    ):
...
class TestAsyncPreIterationVariables:
    ...
    @pytest.mark.asyncio
    async def test_async_pre_iteration_injects_vars(
        self, mock_rlm, mock_repl, mock_history, mock_variables
    ):
