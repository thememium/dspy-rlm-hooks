...
class TestAsyncHooks:
    ...
    def test_async_pre_iteration_hook(self, mock_rlm, mock_repl, mock_history,
                                       mock_variables):
    ...
    def test_async_pre_execution_hook(self, mock_rlm, mock_repl, mock_history,
                                       mock_variables):
    ...
    def test_async_post_execution_hook(self, mock_rlm, mock_repl, mock_history,
                                        mock_variables):
        ...
        mock_rlm._execute_iteration(
            mock_rlm, mock_variables, mock_history, 0,
            {"question": "test"}, ["answer"]
        )
    ...
    def test_async_post_iteration_hook(self, mock_rlm, mock_repl, mock_history,
                                        mock_variables):
    ...
    @pytest.mark.asyncio
    async def test_aexecute_iteration_with_async_hooks(self, mock_rlm, mock_repl,
                                                        mock_history, mock_variables):
        ...
        async def async_post_exec(iteration, code, result, variables, history, input_args):
    ...
    def test_mixed_sync_async_hooks(self, mock_rlm, mock_repl, mock_history,
                                     mock_variables):
    ...
    def test_async_hook_in_sync_context(self, mock_rlm, mock_repl, mock_history,
                                         mock_variables):
