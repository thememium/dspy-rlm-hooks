...
Current state: speculation adds ~84ms overhead (389ms vs 305ms baseline). Shadow construction is2.4ms (optimized from70ms with fork), drain barrier1.5ms, claim wait273ms. Only32ms of tool latency is hidden.
