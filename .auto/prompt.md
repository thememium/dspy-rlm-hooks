...
Current state: speculation adds ~88ms overhead (388ms vs 300ms baseline). Shadow construction is2.4ms (optimized from70ms with fork), drain barrier1.5ms, claim wait272ms. Only29ms of tool latency is hidden.
